...
export default function ContentPage({
  ...
  const thumbnail = image || kreoBG;
  const information = <div className='flex flex-col items-center w-full overflow-y-auto gap-4'>
            <Image src={thumbnail} alt="Main Image" width={1200} height={400} className='w-full h-64 object-cover'/>
            <div className='flex flex-col items-start p-8 w-full gap-4'>
